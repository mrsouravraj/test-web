...
app.get("/",function( req , res ){
    ...
    Blog.find({}, function(err , allCampgrounds){
        if(err){
            console.log(err);
        } else {
             res.render("blogs/index",{campgrounds: allCampgrounds});
        }
    });
});
...
app.post("/blogs", function(req, res){
    ...
    Blog.create(newCampground , function(err,newlyCreated){
        if(err){
            console.log(err);
        } else {
...
app.get("/blogs/:id", function(req, res) {
    ...
    Blog.findById(req.params.id).populate("comments").exec(function(err, foundCampground){
        if(err){
            console.log(err);
        } else {
